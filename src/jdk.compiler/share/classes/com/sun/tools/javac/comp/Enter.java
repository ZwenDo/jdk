 ...
 *************************************************************************/
    ...
    public void visitClassDef(JCClassDecl tree) {
        ...
        var newGenericsFlag = TransParameterizedTypes.newGenericsExcluded(c) ? NEW_GENERICS_EXCLUDED : 0;
        // Fill out class fields.
        c.completer = Completer.NULL_COMPLETER; // do not allow the initial completer linger on.
        c.flags_field = chk.checkFlags(tree.mods.flags, c, tree) | FROM_SOURCE | newGenericsFlag;
