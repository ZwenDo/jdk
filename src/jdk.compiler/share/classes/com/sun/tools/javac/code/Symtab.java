...
public class Symtab {
    ...
    public final Type specializedTypeType;
    ...
    protected Symtab(Context context) throws CompletionFailure {
        ...
        specializedTypeType = enterClass("java.util.ptype.model.SpecializedType");
        ...
        intersectionType = enterClass("java.util.ptype.model.IntersectionType");
